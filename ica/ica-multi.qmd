...
Bimodal shape, suggesting that one group/cluster performed higher and another cluster performed low. The range is between is between 840 and 1120 
...
```{r}
ggplot(education, aes(y = sat, x = salary, color = salary)) + 
  geom_point() + 
